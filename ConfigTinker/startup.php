        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-sm text-center">
                    ...
                    <br/>
                    <div>RAM & Disk :<div id="RAM">Error</div></div>
                </div>
                ...
                <div class="col-sm text-center">
                    ...
                    <br/>
                    <div>Sensor : <div id="display">Error</div></div>
                </div>
                ...
                <div class="col-sm text-center">
                    ...
                    <br/>
                    <div>CPU Charge :<div id="CPULoad">Error</div></div>
                </div>
                <!-- NET Block -->
                <div class="col-sm text-center">
                    <script type="text/javascript">
                    ...
                    <br/>
                    <div>NET adress :<div id="NETadd">Error</div></div>
                </div>
            </div><!-- End of the row -->
